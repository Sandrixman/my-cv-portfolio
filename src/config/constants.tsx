...
export interface SocialLink {
    ...
    href: string
    icon: ReactNode
    name?: string // For footer
    // Styling classes for Contact section
    buttonClass?: string
    iconClass?: string
...
export const socialLinks: SocialLink[] = [
    ...
    },
    {
        ...
        buttonClass:
            "border-gray-500/20 hover:shadow-gray-400/30 hover:border-gray-400/50 hover:from-gray-500/10",
        iconClass: "text-gray-800 dark:text-gray-300 group-hover:text-gray-900 dark:group-hover:text-gray-200",
        gradientClass: "via-gray-500/20",
    },
    {
        id: "linkedin",
